...
Vue.component("edit-time", require("./components/admin/time/edit.vue").default);

//constant
Vue.component(
  "create-constant",
  require("./components/admin/constant/create.vue").default
);
Vue.component(
  "index-constant",
  require("./components/admin/constant/index.vue").default
);
Vue.component(
  "edit-constant",
  require("./components/admin/constant/edit.vue").default
);
