<template>
  <div style="text-align:right">
    ...
    <b-col sm="12">
      <b-form-group
        label="هل الكوبون سيكون نسبة ام سعر ثابت علم علي هذا الاختيار اذا كان نسبة مثلا ١٠٪ او اتركه لكي يكون رقم ثابت مثلا ٢٠ ريال:"
        label-for="product-isPercent"
        description="هو الحد الادنى لمجموع المبلغ فى السلة  "
      >
        <b-form-checkbox id="product-isPercent" type="check" v-model="isPercent"></b-form-checkbox>
      </b-form-group>
    </b-col>
    <b-col sm="12">
      <b-form-group
        :label="isPercent ? 'الخصم بالنسبة المئوية' :'قيمة الخصم بالريال'"
        label-for="product-title"
        description="لو اخترت الاختيار السابق ستكون هذه نسبة مئوية مثلا ٢٠ سيخصم ٢٠ بالمئة و في حالة عدم اختيارك للاختيار السابق ستكون قيمة ثابتة  "
      >
