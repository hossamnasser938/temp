...
module.exports = {
  ...
  update: function(req, res) {
    ...
    paymentMethodsModel.findOne({ _id: id }, function(err, paymentMethods) {
      ...
      paymentMethods.nameAr = req.body.nameAr
        ? req.body.nameAr
        : paymentMethods.nameAr;
      paymentMethods.nameEn = req.body.nameEn
        ? req.body.nameEn
        : paymentMethods.nameEn;
      paymentMethods.cities = req.body.cities
        ? req.body.cities
        : paymentMethods.cities;
  ...
  renderUpdate: async (req, res) => {
    try {
      const payment = await paymentMethodsModel
